 ...
 * author         : SSAFY
 * date           : 2023-04-20
 * description    : 보안해제 URL, 프론트에서 접근할 URL, 로그인 및 회원가입이 끝나면 Redirect될 URL 등 이 세팅되어 있다.
 * <p>
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
...
//    public static final String SECURITY_AFTER_LOGIN = "https://blahblah.site/user/login/callback";
    public static final String SECURITY_AFTER_LOGIN = "http://localhost:8080/user/login/callback";

    //소셜 로그인의 과정중에 쓰일 url, 소셜로그인 세팅과 같아야 함.
//    public static final String DEFAULT_REDIRECT_URL = "https://sanneomeo.site/api/user/login/callback/{registrationId}";
