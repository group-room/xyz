...
import static com.grouproom.xyz.global.auth.Constants.DEFAULT_REDIRECT_URL;


/**
 * packageName    : com.grouproom.xyz.global.auth
 * fileName       : CustomOAuth2Provider
 * author         : SSAFY
 * date           : 2023-04-20
 * description    : ENUM으로 설정되어 있어서 각 소셜 로그인 설정 링크를 가져오기 좋다.
 * <p>
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
