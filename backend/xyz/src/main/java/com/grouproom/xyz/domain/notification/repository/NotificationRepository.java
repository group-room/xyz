...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    List<Notification> findNotificationsByUser_SequenceAndIsDeletedOrderByCreatedAtDesc(Long userSeq, Boolean isDeleted);

    List<Notification> findNotificationsByUser_SequenceAndIsDeletedAndNotificationTypeOrderByCreatedAtDesc(Long userSeq, Boolean isDeleted, NotificationType notificationType);
